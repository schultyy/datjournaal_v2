defmodule Datjournaal.UserStatsController do
  ...
  defp my_posts(user) do
    ...
    Repo.all(from stat in Stat, group_by: stat.image_post_id, where: stat.image_post_id in ^my_posts and stat.authenticated == false, select: {stat.image_post_id, count(stat.image_post_id)})
